...
Step 1: Channel Mapping (channels.conf)
Create channels.conf and list your mappings (TelegramID WhatsAppID).
(ඔබේ ටෙලිග්‍රෑම් සහ වට්ස්ඇප් ID මෙහි ඇතුළත් කරන්න).

```Text
-1003870071105    94778212616
-1001977201046    120363424278414604@g.us
```
